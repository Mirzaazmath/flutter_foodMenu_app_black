...
import 'package:flutter_foodapp_black1/Screens/starclipper.dart';
                ...
                child: Stack(
                  children: [
                    SizedBox(
                      ...
                      child: Text(item.name,style: const TextStyle(fontWeight: FontWeight.w900,fontSize: 60,color: Color(0xff212933)),textAlign: TextAlign.center,),
                    ),
                    Center(
                      child:  Hero(
                        tag: "$index",
